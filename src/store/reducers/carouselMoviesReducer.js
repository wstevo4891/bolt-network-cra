...
export default function carouselMoviesReducer(state = initialState, action) {
  switch (action.type) {
    case FETCH_CAROUSEL_MOVIES_BEGIN:
    ...
    case FETCH_CAROUSEL_MOVIES_FAILURE:
